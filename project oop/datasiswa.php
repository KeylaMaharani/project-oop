...
<body>
    ...
    <form action="" method="POST">
        <div class="d-flex flex-row justify-content-center grid gap-3 position-relative hstack mt-4">
            ...
            <div><br><button style="width: 120px" class="btn btn-primary h-25 shadow" type="submit" name="kirim">Kirim</button>
            <button style="width: 120px" class="btn btn-danger h-25 shadow" type="submit" name="reset">Reset</button></div>
        </div>
    </form>
    <br>
    <?php
...
if(!empty($_SESSION['dataSiswa'])){
    echo '<table class="table table-hover w-75 mt-4 ms-auto me-auto">';
